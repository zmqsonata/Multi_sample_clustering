...
run_Bass_multi_harmony <- function(samples, cnt_paths, xy_paths, genes_paths, cluster_num) {
    ...
    BASS <- BASS.preprocess(BASS,doLogNormalize = TRUE, doPCA = TRUE, scaleFeature = TRUE, nPC = 20, doBatchCorrect = TRUE
    BASS <- BASS.run(BASS)
